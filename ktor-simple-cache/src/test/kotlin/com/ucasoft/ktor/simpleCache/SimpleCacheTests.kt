...
//                 it.byteContent.toString().shouldBe("Test")
//             }
//
...
//                 1 -> {
//                     responses[iteration].shouldHaveStatus(HttpStatusCode.OK)
//                     responses[iteration].shouldBe(responses[0].byteContent)
//                     responses[iteration].byteContent?.toString()?.toInt().shouldBe(responses[0].byteContent?.toString()?.toInt())
...
//                 3 -> {
//                     responses[iteration].shouldHaveStatus(HttpStatusCode.OK)
//                     responses[iteration].byteContent?.toString()?.toInt().shouldBe(responses[2].byteContent?.toString()?.toInt())
...
//                 4 -> {
//                     responses[iteration].shouldHaveStatus(HttpStatusCode.OK)
//                     responses[iteration].byteContent?.toString()?.toInt().shouldBe(responses[3].byteContent?.toString()?.toInt())
